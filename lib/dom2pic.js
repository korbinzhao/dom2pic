...
class Dom2pic {
  ...
  async toMultiPic(childNodeClassName) {
    ...
    try {
      for (var _iterator = _asyncIterator(childNodes), _step, _value; _step = await _iterator.next(), _iteratorNormalCompletion = _step.done, _value = await _step.value, !_iteratorNormalCompletion; _iteratorNormalCompletion = true) {
        const node = _value;
        const {
          left,
          top,
